              ...
              child: Column(
                children: [
                  ClipRRect(
                      ...
                      child: Image.asset("assets/map_pin.png", height: 150,)
                  ),
                  SizedBox(
                    height: 30,
                  ),
              ...
              bodyWidget: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.home_work_outlined, color: Theme
                            .of(context)
                            .accentColor,),
                        SizedBox(width: 15,),
                        DropdownButtonHideUnderline(
...
//****************************************************************************save config*******************************************************************************************
  ...
  Future saveConfig() async {
    ...
    await _queryCtr.addItemToTable(DbTablesNames.myparams, _myParams);
    await _queryCtr .addItemToTable(DbTablesNames.profile, _profile);
  }
